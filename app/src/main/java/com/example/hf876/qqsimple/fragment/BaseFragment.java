...
//		View v = inflater.inflate(R.layout.messages_layout, container, false);
    ...
    public static BaseFragment newInstance(Context context,String tag){
        ...
        if(TextUtils.equals(tag, Constants.FRAGMENT_FLAG_CONTACTS)){
            baseFragment = new ContactsFragment();
        }else if(TextUtils.equals(tag, Constants.FRAGMENT_FLAG_MESSAGE)){
            baseFragment = new MessageFragment();
        }else if(TextUtils.equals(tag, Constants.FRAGMENT_FLAG_NEWS)){
            baseFragment = new NewsFragment();
        }
//        else if(TextUtils.equals(tag, Constants.FRAGMENT_FLAG_MENU)){
//            baseFragment = new MenuLeftFragment();
//        }
